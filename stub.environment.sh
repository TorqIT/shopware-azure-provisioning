...
export INCLUDE_DATABASE_IN_VIRTUAL_NETWORK=false
export VIRTUAL_NETWORK_ADDRESS_SPACE_PREFIX='11.0.0.0/16'
export VIRTUAL_NETWORK_SUBNET_ADDRESS_SPACE_PREFIX='11.0.0.0/23'

# Database
export DATABASE_SERVER_NAME=
export DATABASE_ADMIN_USER=adminuser
export DATABASE_NAME=pimcore
export DATABASE_SKU_CAPACITY=1
export DATABASE_SKU_NAME=B_Gen5_1
export DATABASE_SKU_SIZE_MB=5120
export DATABASE_SKU_TIER=Basic
export DATABASE_SKU_FAMILY=Gen5
export DATABASE_BACKUP_RETENTION_DAYS=7
export DATABASE_GEO_REDUNDANT_BACKUP=Disabled
